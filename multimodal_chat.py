...
sub_title_markdown = """
\n\n
📚 For more details refer to our blog:
- [LLaVA-NeXT: Stronger LLMs Supercharge Multimodal Capabilities in the Wild](https://llava-vl.github.io/blog/2024-05-01-llava-next-video/)
\n\n
...
if __name__ == "__main__":
    ...
    with gr.Blocks(
        ...
        css=".message-wrap.svelte-1lcyrx4>div.svelte-1lcyrx4 img, .message-wrap.svelte-1lcyrx4>div.svelte-1lcyrx4 video {max-width: 80px}",
    ) as demo:
        ...
        chatbot = gr.Chatbot(
            [],
            label=f"Model: {args.model_name} | Temperature: {args.temperature} | Max New Tokens: {args.max_new_tokens}",
            elem_id="chatbot",
